...
const messages = {
  id: {
    ...
    heroBody: "Latihan membaca dengan 50 soal yang telah ditinjau, pilihan mode ujian 70 menit atau latihan tanpa batas waktu, dan analisis jawaban yang akurat.",
    chooseTest: "Pilih simulasi",
    chooseSubtitle: "Setiap paket berisi 50 soal membaca dan bernilai total 100 poin.",
    timed: "Mode ujian",
  ...
  ko: {
    ...
    heroBody: "검수된 읽기 50문항을 실전 70분 또는 시간 제한 없는 연습 모드로 풀고, 정확한 응답 분석과 오답 해설을 확인할 수 있습니다.",
    chooseTest: "모의고사 선택",
    chooseSubtitle: "각 회차는 읽기 50문항, 총 100점으로 구성됩니다.",
    timed: "실전 모드",
